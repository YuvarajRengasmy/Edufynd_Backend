...
import { getAllApplicationStatus, getSingleApplicationStatus, createApplicationStatus, updateApplicationStatus, 
    deleteApplicationStatus,
     getFilteredApplicationStatus } from '../../moduleSetting/controller/studentEnquiryStatus.controller';
...
router.get('/getSingleStudentStatus',
    basicAuthUser,
    checkQuery('_id'),
...
router.put('/getFilterStudentStatus',
    basicAuthUser,
