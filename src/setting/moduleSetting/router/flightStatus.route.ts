...
import { getAllApplicationStatus, getSingleApplicationStatus, createApplicationStatus, updateApplicationStatus,
     ...
     getFilteredApplicationStatus } from '../../moduleSetting/controller/flightEnquiryStatus.controller';
...
router.get('/getSingleFlightStatus',
    basicAuthUser,
    checkQuery('_id'),
...
router.put('/getFilterFlightStatus',
    basicAuthUser,
