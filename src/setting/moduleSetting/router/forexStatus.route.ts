...
import { getAllApplicationStatus, getSingleApplicationStatus, createApplicationStatus, updateApplicationStatus,
     ...
     getFilteredApplicationStatus } from '../../moduleSetting/controller/forexEnquiryStatus.controller';
...
router.get('/getSingleForexStatus',
    basicAuthUser,
    checkQuery('_id'),
...
router.put('/getFilterForexStatus',
    basicAuthUser,
