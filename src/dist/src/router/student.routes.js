...
router.get('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, student_controller_1.getAllStudent);
...
router.put('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, (0, Validators_1.checkRequestBodyParams)('_id'), fileUploaded_1.default.fields([
...
router.delete('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, (0, Validators_1.checkQuery)('_id'), student_controller_1.deleteStudent);
...
checkAuth_1.basicAuthUser, tokenManager_1.checkSession, 
// // checkQuery('_id'),
login_controller_1.forgotPassword);
