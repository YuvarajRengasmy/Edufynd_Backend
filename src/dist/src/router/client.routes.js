...
router.get('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, client_controller_1.getAllClient);
...
router.delete('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, (0, Validators_1.checkQuery)('_id'), client_controller_1.deleteClient);
