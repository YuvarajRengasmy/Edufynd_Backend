...
router.get('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, program_controller_1.getAllProgram);
...
router.delete('/', checkAuth_1.basicAuthUser, tokenManager_1.checkSession, (0, Validators_1.checkQuery)('_id'), program_controller_1.deleteProgram);
router.get('/getAllProgramForWeb', // get all program for web //without checking session
checkAuth_1.basicAuthUser, tokenManager_1.checkSession, program_controller_1.getAllProgramForWeb);
