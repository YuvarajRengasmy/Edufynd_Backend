...
export let getAllAdmin = async (req:any, res:any, next:any) => {
    try {
...
export let getSingleAdmin = async (req:any, res:any, next:any) => {
    try {
...
export let createAdmin = async (req:any, res:any, next:any) => {
...
export let createStudentByAdmin = async (req:any, res:any, next:any) => {
    const errors = validationResult(req);
...
export let createStaffByAdmin = async (req:any, res:any, next:any) => {
    const errors = validationResult(req);
