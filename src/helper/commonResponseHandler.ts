...
export let response = function (req:any, res:any, activity:any, level:any, method:any, success:any, statusCode:any, result:any, message:any, extendedMessage?:any) {
...
export const sendEmail = async (req:any, toMail:any, subject?: any, text?: any) => {
    ...
    await sender.sendMail(composemail, function (error:any, info:any) {
        if (error) {
            console.log(error);
        } else {
